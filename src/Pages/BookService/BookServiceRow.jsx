...
const BookServiceRow = ({ booking , handleDelete, handleConfirm}) => {
    ...
    return (
        <tr>
            <th>
                <button onClick={()=> handleDelete(_id)} className="btn btn-circle btn-error text-white">
                    <svg
